...
const Default = (props) => {
  ...
  const getProfile = async () => {
    ...
    try {
      ...
      setMembers(localStorage.members)
    } catch (err) {
          ...
          <Row className="second-chart-list third-news-update">
            ...
            <Col xl="4 xl-50" lg="12" className="calendar-sec box-col-6">
              <Row>
                ...
                <Col sm="6" xl="6" lg="6">
                  <Card className="o-hidden" style={{ height:'75%', boxShadow: '5px 5px 20px #263238', marginTop:'-5%'}}>
                    <CardBody className="bg-secondary b-r-4">
                      <div className="media static-top-widget">
                        ...
                        <div className="media-body"><span className="m-0">Registered Hospitals</span>
                          <h4 className="mb-0 counter"><CountUp end={24} /></h4><LocalHospitalIcon className="icon-bg" />
                        </div>
                      </div>
                    </CardBody>
                  </Card>
